--The Phantom Knights of Specter Lance
local s,id=GetID()
...
function s.spfilter(c,e,tp)
    return c:IsSetCard(0x10db) and c:IsLevel(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.thfilter(c)
    return c:IsSetCard(0x10db) and c:IsLevel(4) and c:IsAbleToHand()
end
