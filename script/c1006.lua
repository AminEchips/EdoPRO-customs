...
function s.initial_effect(c)
	...
	-- Special Summon from hand by banishing an Icejade / Albaz / mentions Albaz from GY
	...
	-- Quick Effect: Protect another monster from battle destruction
...
-- e1: Fusion or Synchro protection condition
...
-- e3: Protect another face-up monster from battle destruction
