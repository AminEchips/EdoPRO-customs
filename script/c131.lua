...
function s.initial_effect(c)
    ...
    e0:SetValue(0x254) -- Adjust this to match your Pendulumgraph setcode
    c:RegisterEffect(e0)
    ...
    -- GY effect: search 2 "Magician" Pendulum monsters and send 1 to GY
...
-- Filter for "Magician" Pendulum Monsters
