...
-- Protect Altergeist monsters from destruction by card effects
function s.repfilter(c,tp)
    return c:IsControler(tp) and c:IsFaceup() and c:IsSetCard(0x103) and c:IsOnField() and not c:IsReason(REASON_REPLACE)
end
...
function s.repop(e,tp,eg,ep,ev,re,r,rp)
    -- Nothing else needed; overlay removal handled above
end

-- Banish 2 Altergeist to revive self
