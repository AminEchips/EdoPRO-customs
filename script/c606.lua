...
function s.initial_effect(c)
    ...
    c:RegisterEffect(e1)
    -- If banished: Add 1 Spell/Trap that mentions "Blackwing"
...
----------------------------------------------------------
-- Search a Spell/Trap mentioning "Blackwing" if banished
----------------------------------------------------------
function s.thfilter(c)
    return c:IsSpellTrap() and c:IsAbleToHand() and aux.TextContains(c,"Blackwing")
end
