...
-- Second effect: Tribute 1 LIGHT monster; Special Summon 1 "Starry Knight" from hand or GY
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
    ...
    if chk==0 then return Duel.IsExistingTarget(s.trfilter,tp,LOCATION_MZONE,0,1,nil)
