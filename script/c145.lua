...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--(2) If sent to GY: add to hand or Special Summon (NON-TARGETING)
...
-- "Magician" Pendulum in your face-up Extra Deck
...
function s.gytg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- No target selected here; select at resolution
...
function s.gyop(e,tp,eg,ep,ev,re,r,rp)
	...
	if op==1 then
		if Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)<=0 and tc:IsRelateToEffect(e) and tc:IsAbleToHand() then
