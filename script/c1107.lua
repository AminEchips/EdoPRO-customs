...
function s.initial_effect(c)
	...
	local params={
		function(c) return c:IsType(TYPE_FUSION) and c:IsAttribute(ATTRIBUTE_FIRE) end, -- filter
		nil, -- extra materials (none)
		nil, -- stage2 function (none)
		Fusion.BanishMaterial, -- banish as cost
		nil -- extratarget (none)
	}
	...
	-- Reincarnation effect: Special Summon 1 banished "Salamangreat" + add 1 Salamangreat Spell/Trap
