...
function s.gytg(e,tp,eg,ep,ev,re,r,rp,chk)
    local g=eg:Filter(Card.IsType,nil,TYPE_LINK)
    if chk==0 then return #g>0 and e:GetHandler():IsAbleToRemoveAsCost() end
...
function s.gyop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local g=Duel.SelectTarget(tp,Card.IsType,tp,LOCATION_REMOVED,LOCATION_REMOVED,1,1,nil,TYPE_LINK)
    local tc=g:GetFirst()
