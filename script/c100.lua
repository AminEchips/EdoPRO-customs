...
function s.initial_effect(c)
	...
	--Pendulum Effect: Ask once per turn to prevent effect damage to one player
...
-- Pendulum chain hook: ask to protect from effect damage
function s.chain_op(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SelectYesNo(tp,aux.Stringid(id,0)) then
		...
		-- Register an effect tied to chain + player
