...
function s.initial_effect(c)
	...
	-- Effect 1: Send 1 card from hand or field to GY, target 1 card, it is banished when it leaves
	...
	-- Effect 2: Gain ATK during battle
	...
	-- Effect 3: Banish from GY to summon Albaz or monster that mentions it
...
-- Effect 2: Gain ATK based on materials
...
-- Effect 3: Special Summon Albaz or card that lists it
