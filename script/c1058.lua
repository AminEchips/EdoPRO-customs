...
function s.initial_effect(c)
    s.listed_series={0x189} -- Bystial archetype
    s.listed_names={68468459} -- Fallen of Albaz

    -- Special Summon from hand (Ignition or Quick if opponent controls a monster)
    ...
    -- If Special Summoned this turn: Discard 1 to Special Summon Albaz/Bystial from Deck
...
-- First effect shared with Bystial Druiswurm
