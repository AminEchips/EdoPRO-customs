...
local s,id=GetID()
s.listed_series={SET_BLACKWING,0x33,0x1033} -- Blackwing, Black-Winged Dragon, Assault Blackwing
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if tc and tc:IsRelateToEffect(e) then
        if Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP_DEFENSE)>0 and c:IsFaceup() and c:IsRelateToEffect(e) then
            -- Reduce Level
