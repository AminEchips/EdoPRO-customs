...
function s.initial_effect(c)
	c:EnableReviveLimit()
	-- 1 "Nordic Beast" Tuner + 1+ non-Tuners (must include Thor manually)
...
-- Negate and optionally destroy all opponent monsters
...
-- When leaves field due to opponent: banish self, Special Summon 1 "Thor, Lord of the Aesir"
