...
function s.initial_effect(c)
	...
	-- Effect 3: If sent to GY, add 1 "Branded" Spell/Trap from GY or banished to hand
...
-- Fusion Material filter: 1 monster Special Summoned from Extra Deck
...
-- Target 1 face-up banished card
...
-- Effect 2: Condition (Battle Phase only)
...
-- Effect 3: Add Branded S/T from GY or banished
