...
function s.initial_effect(c)
    ...
    -- If this card is banished for a Fusion Summon: add 1 of your banished "Elemental HERO" monsters to your hand
...
-- Triggered when banished for Fusion
function s.thcon(e,tp,eg,ep,ev,re,r,rp)
    return eg:IsContains(e:GetHandler()) and bit.band(r,REASON_FUSION)~=0
end
